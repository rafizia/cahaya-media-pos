...
export const MetricsRibbon: React.FC<MetricsRibbonProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
      {/* Metric 1: Hari Ini */}
      <div className="bg-white rounded-xl border border-neutral-200 p-4 flex flex-col justify-between shadow-xs">
        ...
        <div className="my-2">
          <span className="text-2xl font-extrabold font-mono text-neutral-900 tabular-nums">
      ...
      <div className="bg-neutral-900 text-white rounded-xl border border-neutral-800 p-4 flex flex-col justify-between shadow-xs">
        <div className="flex items-center justify-between">
        ...
        <div className="pt-2 border-t border-neutral-800 flex items-center justify-between text-xs font-mono">
          <span className="text-neutral-400">Laba Kotor:</span>
          <span className="font-bold text-emerald-400 bg-emerald-950/60 px-2 py-0.5 rounded border border-emerald-800/60 tabular-nums">
